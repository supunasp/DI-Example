...
public class CCPaymentServiceImpl implements PaymentService {

    private List<String> processedSources;

    @Override
    public boolean processPayment(PaymentRequest paymentRequest) {
        System.out.println("CC payment done via " + paymentRequest.getSource() + " with amount=" + paymentRequest.getAmount());
        return true;
    }
